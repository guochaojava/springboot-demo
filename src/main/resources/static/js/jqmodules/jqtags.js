...
layui.define(['jquery', 'layer'], function(exports) {
     ...
     *@todo 初始化方法
     */
    jqtags.prototype.init = function() {
        var _this = this;
        //绑定自定义按钮单击事件
     ...
     *@todo 添加自定义标签
     */
    jqtags.prototype.addTag = function(obj) {
     ...
     *@todo 生成文本框
     */
    jqtags.prototype.text = function(obj) {
        var _this = this;
     ...
     *@todo 自定义单击事件
     */
    jqtags.prototype.click = function(event) {
     ...
     *@todo 选中标签
     */
    jqtags.prototype.select = function(obj) {
     ...
     *@todo 根椐选择的标签设定隐藏域的值
     */
    jqtags.prototype.setval = function(obj, val, sence) {
